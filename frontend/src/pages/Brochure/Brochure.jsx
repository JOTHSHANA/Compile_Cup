...
const MiscellaneousServicesIcon = () => (
  <svg
    ...
    fill="currentColor"
  >
    <path d="M20 7h-3.03l-1.4-1.87c-.2-.27-.5-.43-.84-.43H9.27c-.34 0-.64.16-.84.43L7.03 7H4c-1.1 0-2 .9-2 2v10c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V9c0-1.1-.9-2-2-2zM12 18c-2.76 0-5-2.24-5-5s2.24-5 5-5 5 2.24 5 5-2.24 5-5 5z"></path>
...
const StrategyIcon = () => (
  ...
  >
    <path d="M12 22c5.523 0 10-4.477 10-10S17.523 2 12 2 2 6.477 2 12s4.477 10 10 10zM12 8v4l2 2m-6 3h8"></path>
  </svg>
);
const DesignIcon = () => (
  <svg
    ...
    strokeLinejoin="round"
  >
    <path d="M12 20h9m-9-4h9m-9-4h9M5 20V4l7 8-7 8z"></path>
  </svg>
);
const DevelopIcon = () => (
  <svg
              ...
              <div className="zoom-section">
                ...
                <div className="dev-profile-container">
                  <div className="dev-profile-flex">
                    ...
                    />
                    <div className="dev-info">
                      PRIYADARSHAN B<div>Full Stack Developer</div>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div className="brochure-services">
                  ...
                  <div className="service-info">
                    ...
                    <div className="brochure_paragraphs">
                      Modern, responsive, and feature-rich web applications
              ...
              <div className="zoom-section">
                <div className="brochure-services">
                  ...
                  <div className="service-info">
                    ...
                    <div className="brochure_paragraphs">
                      Cross-platform mobile apps for iOS and Android with a
                ...
                <div className="brochure-services">
                  ...
                  <div className="service-info">
                    ...
                    <div className="brochure_paragraphs">
                      ...
                      your application remains up-to-date and secure.
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="zoom-section">
                <div className="process-step">
                  ...
                  <div className="process-info">
                    ...
                    <p className="brochure_paragraphs">
                      Crafting intuitive and beautiful interfaces that provide
              ...
              <div className="zoom-section">
                <div className="brochure-services">
                  ...
                  <div className="service-info">
                    ...
                    <div className="brochure_paragraphs">
                      We believe in clear communication and an iterative
                      process. You're involved at every step, ensuring the final
                      product perfectly matches your vision.
                    </div>
                  </div>
                </div>
              </div>
              <div className="zoom-section">
                <div className="brochure-services">
                  ...
                  <div className="service-info">
                    ...
                    <div className="brochure_paragraphs">
                      Leveraging the latest, most reliable technologies to build
                      solutions that are not only powerful today but also
              ...
              <div className="zoom-section">
                <div className="brochure-services">
                  ...
                  <div className="service-info">
                    ...
                    <div className="brochure_paragraphs">
                      As a lean team, we offer agency-level quality and
                      dedication without the hefty price tag, providing maximum
